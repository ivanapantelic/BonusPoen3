...
<body>
            ...
            <div class="panel-body">
                <form id="prijavaForm" action="obrada.php" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button id="btn-obrisi" type="submit" name="submit" value="Obrisi" class="btn btn-danger btn-block" disabled>Obriši</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        $('input[name="id_predmeta"]').on('change', function() {
            ...
            let id = $(this).val(); // Dodano za dobijanje ID-a
